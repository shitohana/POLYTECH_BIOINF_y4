...
``` bash
cat file.fasta | seqkit sort -lr | seqkit head -n 3
```
:::
...
augustus \
   ...
   --species=fusarium \ # надо выбрать species!
...
**Не забудьте распаковать файлы .tar.gz:**

``` bash
cd ./busco_downloads/lineages
tar -xzvf fungi_odb10.2024-01-08.tar.gz
```
